...
public class ContactsAppController {
    ...
    public void initialize(){
        contacts.add(new Contact("Yoshida","Nao","nao.yoshida@gmail.com","+77025852719"));
        contacts.add(new Contact("Hirose","Madoka","madoka.hirose@gmail.com","+7709823477"));
        contacts.add(new Contact("Tscuchiya","Ryota","ryotaaa@gmail.com","+77874578723"));
        contacts.add(new Contact("Hino","Tetsuo","hinooo@gmail.com","+7798578237"));
